...
class CreateTaskTest {
  ...
  void shouldNotCreateNewTaskAndReturnUnauthorized() {
    var request = new CreateUpdateTaskRequest(null,"title", "description", null, "test", null);
    RestAssured.given()
      .contentType(ContentType.JSON)
      .body(request)
      .when()
  ...
  void shouldNotCreateNewTaskAndReturnBadRequest() {
    var request = new CreateUpdateTaskRequest(null, null, null, null, "username", null);
    RestAssured.given()
      .contentType(ContentType.JSON)
      .cookie("auth_token", jwtCookie)
      .body(request)
