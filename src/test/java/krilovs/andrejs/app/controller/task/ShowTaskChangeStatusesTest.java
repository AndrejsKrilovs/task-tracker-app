...
@QuarkusTest
class ShowTaskChangeStatusesTest {
  @Inject
  ...
  @Test
  void shouldShowAvailableTaskStatusesReturnOk() {
    RestAssured.given()
      .cookie("auth_token", jwtCookie)
      .when()
      .get("/api/v1/task-tracker/tasks/statusesToChange/READY_FOR_DEVELOPMENT")
      .then()
      .statusCode(200)
  ...
  @Test
  void shouldNotShowAvailableTaskStatusesReturnUnauthorized() {
    RestAssured.given()
      .contentType(ContentType.JSON)
      .when()
      .get("/api/v1/task-tracker/tasks/statusesToChange/READY_FOR_DEVELOPMENT")
